create database orgonization_db;
...
insert into products(id, name, suplier_id, category_id, unit, price) values
(1, "Chais", 1, 1, "10 boxes x 0 bags", 18), 
...
select id , unit, price from products where category_id = 1;

select name , price from products where price between 10 and 30;

select name , price from products where price = (select min(price) from products);

select name, price from products where suplier_id = 2;

select name, unit from products where unit like '%bottles%';

select name, price from products where category_id = 8;

select name, unit, price from products where suplier_id = 7;

select name, price from products order by price desc;

select name, price from products where price < 20;

select id, name from products where name like 'Ch%';